# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-12-11 08:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_name.Address', verbose_name='收货地址')),
                ('passport', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_name.Passport', verbose_name='下单账户')),
            ],
            options={
